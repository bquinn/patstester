...
from .views import (
    ...
    Buyer_ListSellerInitiatedProposalsView,
...
urlpatterns = [
    ...
    url(r'^buyer/seller-initiated-proposals',
        Buyer_ListSellerInitiatedProposalsView.as_view(template_name='buyer_campaigns_sips_list.html'),
        name='buyer_campaigns_sips_list'),
