...
from .views import (
    ...
    Buyer_CreateRFPView, Buyer_RFPDetailView, Buyer_RFPSearchView, Buyer_RFPAttachmentView,
    Buyer_ReturnProposalView,
...
urlpatterns = [
    ...
    url(r'^buyer/rfps/(?P<rfp_id>[\w\-]+)/attachments/(?P<attachment_id>[\w\-]+)',
        Buyer_RFPAttachmentView.as_view(template_name='buyer_rfps_attachment_view.html'),
