...
urlpatterns = [
    ...
    url(r'^seller/orders/(?P<order_id>[\w\ \-\.]+)/attachments/(?P<attachment_id>[\w\ \-\.]+)/download',
        Seller_DownloadOrderAttachmentView.as_view(template_name='buyer_orders_attachment_download.html'),
        name='seller_order_attachment_download'),
    url(r'^seller/orders/(?P<order_id>[\w\ \-\.]+)/attachments/(?P<attachment_id>[\w\ \-\.]+)',
        Seller_ViewOrderAttachmentView.as_view(template_name='buyer_orders_attachment_download.html'),
